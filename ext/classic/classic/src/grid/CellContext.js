...
Ext.define('Ext.grid.CellContext', {
     ...
     */
     ...
     /**
      * Creates a new CellContext which references a {@link Ext.view.Table grid}
      * @param {Ext.view.Table} view The {@link Ext.view.Table grid} for which the cell context is needed.
      *
